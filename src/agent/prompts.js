...
export function buildTriagePrompt(input) {
  return [
    ...
    "When present, `local_automation_state` lists automation already approved for this item and running or recently completed (jobs, executed actions, the prior approval). Do not propose work that duplicates it - prefer options that wait for it, complement it, or react to the new activity in light of it, and reference its branch or PR when relevant.",
